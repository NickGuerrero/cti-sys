...
class TestCreateApplication:
    def test_success_min_required_fields(self, mock_mongo_db: MockMongoDatabase):
    ...
    def test_success_with_extra_fields(self, mock_mongo_db: MockMongoDatabase):
        response = client.post("/api/applications", json={
            "fname": "First",
            "lname": "Last",
            "email": "test.user@cti.com",
    ...
    def test_failure_missing_required_last_name(self, mock_mongo_db: MockMongoDatabase):
        response = client.post("/api/applications", json={
            "fname": "First",
            # missing lname
            "email": "test.user@cti.com",
    ...
    def test_failure_invalid_email(self, mock_mongo_db: MockMongoDatabase):
        response = client.post("/api/applications", json={
            "fname": "First",
            "lname": "Last",
            "email": "test.user@cti",
    ...
    def test_failure_duplicate_email_key(self, mock_mongo_db: MockMongoDatabase):
    ...
    def test_application_persistence(self, real_mongo_db: MongoDatabase):
    ...
    @pytest.mark.integration
    def test_application_schema_rejects_invalid_insert(self, real_mongo_db: MongoDatabase):
