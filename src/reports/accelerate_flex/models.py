...
class AccelerateFlexBase(BaseModel):
    ...
    academic_year: Optional[int] = Field(default=None, description="Applicant's year in school")
    grad_year: Optional[str] = Field(default=None, description="Student's expected graduation year")
